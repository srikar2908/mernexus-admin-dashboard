  ...
  return (
    <div className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-slate-950/40 sm:p-8">
      <div className="mb-8 space-y-2">
        ...
        <h2 className="text-2xl font-semibold text-white">Create a new product</h2>
        <p className="text-sm text-slate-300">The form follows the product schema and uses the backend’s required fields.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-5">
        <div>
          <label className="mb-2 block text-sm font-medium text-slate-200" htmlFor="product-name">
            Product name
          </label>
          <input
            id="product-name"
        ...
        <div>
          <label className="mb-2 block text-sm font-medium text-slate-200" htmlFor="product-description">
            Description
          </label>
          <textarea
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            <label className="mb-2 block text-sm font-medium text-slate-200" htmlFor="product-price">
              Price
            </label>
            <input
              id="product-price"
          ...
          <div>
            <label className="mb-2 block text-sm font-medium text-slate-200" htmlFor="product-category">
              Category
            </label>
            <input
              id="product-category"
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            <label className="mb-2 block text-sm font-medium text-slate-200" htmlFor="product-stock">
              Stock
            </label>
            <input
              id="product-stock"
